...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/icy-sun-a361
```

A live public deployment of this template is available at [https://icy-sun-a361.templates.workers.dev](https://icy-sun-a361.templates.workers.dev)
